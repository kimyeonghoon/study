...
public class CommonAOP {
	...
	@Pointcut("execution(* com.spring.sample..TestController.*(..))" 
	          + "&&!execution(* com.spring.sample..TestController.*Log*(..))"
	          + "&&!execution(* com.spring.sample..TestController.*Join(..))"
	          + "&&!execution(* com.spring.sample..TestController.*Ajax(..))"
			  + "&&!execution(* com.spring.sample..TestController.*s(..))")
	public void testAOP() {}
